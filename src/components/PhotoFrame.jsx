  ...
  return (
    <div
      ...
      {framePosition === "bottomLeftTopRight" ? (
        <div
          className={`absolute flex justify-center items-center w-full h-full bg-cover shadow-black bg-red-800 top-[-20px] right-[-20px] ${frameRounded} ${shadow} ${animationClass}`}></div>
      ) : null}
      <div
